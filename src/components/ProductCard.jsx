...
export default function ProductCard({ product, showAddToCart }) {
  return (
    <div style={{ background: "#fff", borderRadius: 10, boxShadow: "0 2px 8px rgba(0,0,0,0.02)", padding: 16, width: 280, height: 400, position: "relative", display: "flex", flexDirection: "column", alignItems: "center", boxSizing: "border-box" }}>
      <div style={{ background: "#f5f5f5", borderRadius: 10, width: 280, height: 190, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16, marginTop: 32, position: "relative", overflow: "hidden" }}>
        {product.discount && (
          <span style={{ position: "absolute", top: 18, left: 18, background: "#db4444", color: "#fff", borderRadius: 4, fontSize: 14, fontWeight: 700, padding: "4px 12px", zIndex: 10 }}>
            -{product.discount}%
          </span>
        )}
