...
export default function NewArrivalSection() {
  return (
    <section style={{ maxWidth: 1200, margin: "48px auto 0", padding: "0 16px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gridTemplateRows: "1fr 1fr", gap: "24px", height: 600 }}>
        {/* PlayStation 5 Large Card */}
        <div style={{ gridRow: "1 / span 2", gridColumn: "1 / 2", background: "#111", color: "#fff", borderRadius: 16, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "32px", minHeight: 420 }}>
        ...
        {/* Women's Collections */}
        <div style={{ gridRow: "1 / 2", gridColumn: "2 / 4", background: "#111", color: "#fff", borderRadius: 16, padding: "32px", display: "flex", flexDirection: "row", alignItems: "flex-end", position: "relative", minHeight: 200, overflow: "hidden" }}>
        ...
        {/* Speakers */}
        <div style={{ gridRow: "2 / 3", gridColumn: "2 / 3", background: "#111", color: "#fff", borderRadius: 16, padding: "32px", display: "flex", flexDirection: "column", justifyContent: "flex-end", position: "relative", minHeight: 200, overflow: "hidden" }}>
        ...
        {/* Perfume */}
        <div style={{ gridRow: "2 / 3", gridColumn: "3 / 4", background: "#111", color: "#fff", borderRadius: 16, padding: "32px", display: "flex", flexDirection: "column", justifyContent: "flex-end", position: "relative", minHeight: 200, overflow: "hidden" }}>
